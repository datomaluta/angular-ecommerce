...
@Component({
  ...
  template: `
    <div
      class="bg-white cursor-pointer rounded-xl shadow-lg overflow-hidden flex flex-col h-full relative transition-all duration-200 ease-out hover:-translate-y-1 hover:shadow-xl"
    >
      <img
